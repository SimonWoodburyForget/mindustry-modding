...
#+TEXINFO_HEADER: Modding documentation for Mindustry v100 (59)
...
** Change Log
   ...
   :END:
   This is a log of changes done on the Mindustry Master branch that affected the modding API.
...
*** {{ log.date_fmt() }}
    ...
    :CUSTOM_ID: {{ log.hash }}
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/{{ log.hash }}][commit]] ={{ log.hash }}= ]   {{ log.message }}
