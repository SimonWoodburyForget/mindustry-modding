...
*** Loadout
    ...
    In Loadout:
    | '>' is stands for conveyor face to right |
    | '^' is stands for conveyor face to up |
    | '<' is stands for conveyor face to left |
    | 'v' is stands for conveyor face to down |
    | '1' is stands for coreShard |
    | '2' is stands for coreFoundation |
    | '3' is stands for coreNucleus |
    | 'C' is stands for mechicalDrill with four copper ore |
...
***** Decoration
    Decoration is a random generator to generate some block in floor you set.
