...
** Consumers
   ...
   | items         | [[ConsumeItems][ConsumeItems]]          |            |
   | liquid        | [[ConsumeLiquid][ConsumeLiquid]]         |            |
   | power         | float or [[ConsumePower][ConsumePower]] |            |
...
** Consume
   :PROPERTIES:
   :DESCRIPTION: base of consumption
   :END:
   ...
   * <<ConsumeLiquid>> ~ConsumePower~, consume a liquid.
