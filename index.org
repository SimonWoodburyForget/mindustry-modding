...
*** BasicBulletType
    ...
    This types purse is to add sprites to bullets. The ~bulletSprite~ will be used as the shape and size of the bullet. The visible pixels in your sprites will be colored with ~backColor~ and ~frontColor~ respectively.
