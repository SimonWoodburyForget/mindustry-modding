...
Modding documentation for Mindustry: /this is a work in progress./ This documentation is being written for bleeding edge.
...
** BulletTypes
   ...
   Bullet is the type typically used to cause damage. It doesn't actually have to be a bullet at all. There are two major categories of bullet types:
   * [[BasicBulletType]]
   * /everything else/
...
*** BasicBulletType
    ...
    This type is special in that it allows you to set colors and sprites.
