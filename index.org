...
#+SUBTITLE: Modding documentation for Mindustry v100 (144)
:PREAMBLE:
...
** NEW Scripts
   ...
   *[new [[#268f3cc3c]]]*
   ...
   For example ~Block~ references the [[Block.java]] class itself, and as a very short example, you could do this:
...
*** extendContent
    ...
    1) ~classType~ the type of class you want to extend;
    2) ~name~ the name of your type;
    3) ~params~ the object which will be used to extend the type.
    
*** print
    
    Function which prints text to stdout with the name of your mod.
...
*** Dec 08
    ...
    :CUSTOM_ID: 268f3cc3c
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/268f3cc3c][commit]] =268f3cc3c= Dec 08 ] =Merge branches 'master' and 'rhino-js-suffering'=
...
*** Dec 04
    ...
    :CUSTOM_ID: a087df077
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/a087df077][commit]] =a087df077= Dec 04 ]   =Added experimental server block syncing=
...
*** Nov 26
    ...
    :CUSTOM_ID: a5fbc0756
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/a5fbc0756][commit]] =a5fbc0756= Nov 26 ]   =Texture overrides / Potential mod texture binding optimizations=
...
*** Nov 22
    ...
    :CUSTOM_ID: 2d4270406
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/2d4270406][commit]] =2d4270406= Nov 22 ]   =Switched to hjson extension=
...
*** Nov 22
    ...
    :CUSTOM_ID: 2c61fcdfa
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/2c61fcdfa][commit]] =2c61fcdfa= Nov 22 ]   =Added optional mod minimum game version=
...
*** Nov 20
    ...
    :CUSTOM_ID: 968f3ace3
    :END:
    [ [[https://github.com/Anuken/Mindustry/commit/968f3ace3][commit]] =968f3ace3= Nov 20 ]   =Better mod parsing=
