...
*** Abstract
    ...
    All you need to know about abstract types, is this is a Java specific term, which means you cannot instantiate/initialize this specific type by itself. If you do so you'll probably get an /"initialization exception"/ of some kind.
...
** BlockStorage
   ...
   [[Abstract]] type that extends [[Content Type][UnlockableContent]] -- This is for blocks that can store a buffer of items.
...
** Content Type
   ...
   At the base of all your content, there's a type called ~Content~, with related ~UnlockableContent~ and ~MappableContent~. This type is at the base of most your content; [[ItemStack][ItemStack]] for example isn't ~UnlockableContent~, because obviously it's not content at all, it's just a stack of items.

   For purposes of JSON modding, all you need to know is this means your type can have ~name~ and ~description~ fields.
...
** Item
   ...
   Extends [[Content Type][UnlockableContent]] -- It's the object that can ride conveyors, sorters and be stored in containers, and is commonly used in crafters.
...
** Liquid
   ...
   Extends [[Content Type][UnlockableContent]] -- Object that defines the properties of a liquid.
...
** UnitType
   ...
   Extends [[Content Type][UnlockableContent]]
...
** Mech
   ...
   Extends [[Content Type][UnlockableContent]] -- Mechs are the player controlled entities.
...
** Zone
   ...
   Extends [[Content Type][UnlockableContent]] -- Type used to get maps into campaign.
