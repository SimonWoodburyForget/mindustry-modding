...
** Attributes
   ...
   Used inside of ~Floor~ type, to give a tile attributes, like ~heat~. This is an object with an array of attributes, with specific attribute values at each index.
