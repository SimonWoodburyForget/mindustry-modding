...
** TODO Consumers
   ...
   This type is commonly used in blocks with the field `consumes`, it's a type that allows your block to consume something.
...
*** TODO SolidPump
    ...
    | field              | type      | default       |
    |--------------------+-----------+---------------|
    | result             | Liquid    | Liquids.water |
    | updateEffect       | Effect    | Fx.none       |
    | updateEffectChance | float     | 0.02f         |
