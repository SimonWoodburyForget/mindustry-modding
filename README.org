...
*** TODO ItemBridge
    ...
    Sprites:
    * =<name>-end= [[https://raw.github.com/Anuken/Mindustry/tree/master/core/assets-raw/sprites/blocks/distribution/bridge-conveyor-end.png][example]]
    * =<name>-bridge= [[https://github.com/Anuken/Mindustry/tree/master/core/assets-raw/sprites/blocks/distribution/bridge-conveyor-bridge.png][example]]
    * =<name>-arrow= [[https://raw.githubusercontent.com/Anuken/Mindustry/master/core/assets-raw/sprites/blocks/distribution/bridge-conveyor-arrow.png][example]]
